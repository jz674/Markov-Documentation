...
Markov is focused on the API/Service layer of testing. At its core, Markov provides confidence that new code will not systemically break previously developed software by letting you 'regression test' on-demand, as part of your git-workflow.
